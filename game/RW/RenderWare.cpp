...
RwImage* 	(*RwTextureRead)(const RwChar *filename, const RwChar *imageName);
RwImage* 	(*RwTextureDestroy)(RwTexture *rwTexture);
...
void InitRenderWareFunctions()
{
	...
	*(void **)(&RwTextureRead)					= (void*)(g_libGTASA+0x1B2558+1);
	*(void **)(&RwTextureDestroy)				= (void*)(g_libGTASA+0x1B1808+1);
}