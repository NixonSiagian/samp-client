...
void (*CWeapon__FireSniper)(WEAPON_SLOT_TYPE *thiz, PED_TYPE* pFiringEntity); 
void CWeapon__FireSniper_hook(WEAPON_SLOT_TYPE* thiz, PED_TYPE* pFiringEntity) 
{ 
	...
	CWeapon__FireSniper(thiz, pFiringEntity); 
}
...
uint32_t CWorld__ProcessLineOfSight_hook(VECTOR * vecOrigin, VECTOR * vecEnd, VECTOR * vecPos, PED_TYPE ** ppEntity, bool b1, bool b2, bool b3, bool b4, bool b5, bool b6, bool b7, bool b8)
{
	...
	dwRetAddr -= g_libGTASA;
	if(dwRetAddr == 0x0055E2FE + 1 || dwRetAddr == 0x005681BA + 1 || dwRetAddr == 0x00567AFC + 1)
	{
